...
do
    ...
    cp src/qt/res/icons/logo.icns ${PACKAGE_DIR}/Contents/Resources/logo.icns
    # find the dylibs to copy for zerod
...
for binary in "${binaries[@]}";
do
    # modify zerod to point to dylibs
...
create-dmg --volname "zero-qt-mac" --volicon "zcutil/res/logo.icns" --window-pos 200 120 --icon "Zero.app" 200 190  --app-drop-link 600 185 --hide-extension "Zero.app"  --window-size 800 400 --hdiutil-quiet --background zcutil/res/dmgbg.png  zero-qt-mac.dmg Zero.app
