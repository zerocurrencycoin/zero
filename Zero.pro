...
HEADERS += \
     ...
     src/qt/guiutil.h \
     src/qt/intro.h \
     src/qt/zeroaddressvalidator.h \
     src/qt/zeroamountfield.h \
     src/qt/zerounits.h \
...
SOURCES += \
    ...
    src/qt/intro.cpp \
    src/qt/zero.cpp \
    src/qt/zeroaddressvalidator.cpp \
    src/qt/zeroamountfield.cpp \
    src/qt/zerostrings.cpp \
    src/qt/zerounits.cpp \
...
# also add new translations to zero.qrc under translations/
TRANSLATIONS = $$files(src/qt/locale/zero_*.ts)
...
OTHER_FILES += \
    doc/*.rst doc/*.txt doc/README README.md src/qt/res/zero-qt-res.rc
...
windows:RC_FILE = src/qt/res/zero-qt-res.rc
