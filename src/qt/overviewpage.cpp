...
public:
    explicit TxViewDelegate(const PlatformStyle *_platformStyle, QObject *parent=nullptr):
        QAbstractItemDelegate(parent), unit(ZeroUnits::ZER),
                      ...
                      const QModelIndex &index ) const
    {
        ...
        {
            QSettings settings;
            if (settings.value("strTheme", "zero").toString() == "dark") {
        ...
        else if(amount > 0)
        {
            ...
            } else if (settings.value("strTheme", "zero").toString() == "zero") {
                foreground = COLOR_POSITIVE_ZERO;
            } else {
        ...
        painter->setPen(foreground);
        QString amountText = ZeroUnits::formatWithUnit(unit, amount, true, ZeroUnits::separatorAlways);
        if(!confirmed)
        {
...
void OverviewPage::setBalance(const CAmount& balance, const CAmount& unconfirmedBalance, const CAmount& immatureBalance, const CAmount& watchOnlyBalance, const CAmount& watchUnconfBalance, const CAmount& watchImmatureBalance, const CAmount& privateWatchBalance, const CAmount& privateBalance, const CAmount& interestBalance)
{
    ...
    ui->labelBalance->setText(ZeroUnits::formatWithUnit(unit, balance, false, ZeroUnits::separatorAlways));
    ui->labelUnconfirmed->setText(ZeroUnits::formatWithUnit(unit, unconfirmedBalance, false, ZeroUnits::separatorAlways));
    ui->labelImmature->setText(ZeroUnits::formatWithUnit(unit, immatureBalance, false, ZeroUnits::separatorAlways));
    ui->labelTotal->setText(ZeroUnits::formatWithUnit(unit, balance + unconfirmedBalance + immatureBalance + privateBalance + interestBalance, false, ZeroUnits::separatorAlways));
    ui->labelWatchAvailable->setText(ZeroUnits::formatWithUnit(unit, watchOnlyBalance, false, ZeroUnits::separatorAlways));
    ui->labelWatchPending->setText(ZeroUnits::formatWithUnit(unit, watchUnconfBalance, false, ZeroUnits::separatorAlways));
    ui->labelWatchImmature->setText(ZeroUnits::formatWithUnit(unit, watchImmatureBalance, false, ZeroUnits::separatorAlways));
    ui->labelWatchTotal->setText(ZeroUnits::formatWithUnit(unit, watchOnlyBalance + watchUnconfBalance + watchImmatureBalance, false, ZeroUnits::separatorAlways));
    ui->labelPrivateWatchBalance->setText(ZeroUnits::formatWithUnit(unit, privateWatchBalance, false, ZeroUnits::separatorAlways));
    ui->labelPrivateBalance->setText(ZeroUnits::formatWithUnit(unit, privateBalance, false, ZeroUnits::separatorAlways));
    ui->labelInterestBalance->setText(ZeroUnits::formatWithUnit(unit, interestBalance, false, ZeroUnits::separatorAlways));
