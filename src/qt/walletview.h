...
#ifndef ZERO_QT_WALLETVIEW_H
#define ZERO_QT_WALLETVIEW_H
...
public:
    ...
    void setZeroGUI(ZeroGUI *gui);
    /** Set the client model.
        The client model represents the part of the core that communicates with the P2P network, and is wallet-agnostic.
    */
    void setClientModel(ClientModel *clientModel);
    /** Set the wallet model.
        The wallet model represents a zero wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
...
private:
    ...
    ZeroNodePage *zeroNodeView;
    QWidget *zeroNodePage;
...
public Q_SLOTS:
    //switch between recieve address types
    void showZAddresses();
    void showTAddresses();
