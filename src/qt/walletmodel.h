...
#ifndef ZERO_QT_WALLETMODEL_H
#define ZERO_QT_WALLETMODEL_H
...
/** Interface to Zero wallet from Qt view code. */
...
public:
    ...
    GlobalZNTableModel *getGlobalZNModel();
    LocalZNTableModel *getLocalZNModel();
    ...
    CAmount getPrivateWatchBalance() const;
...
private:
    ...
    GlobalZNTableModel *globalZeronodeTableModel;
    LocalZNTableModel *localZeronodeTableModel;
    ...
    CAmount cachedWatchPrivateBalance;
...
Q_SIGNALS:
    ...
    void balanceChanged(const CAmount& balance, const CAmount& unconfirmedBalance, const CAmount& immatureBalance,
                        ...
                        const CAmount& watchPrivateBalance, const CAmount& privateBalance, const CAmount& interestBalance);
