...
#ifndef ZERO_QT_ZEROUNITS_H
#define ZERO_QT_ZEROUNITS_H
...
/** Zero unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class ZeroUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit ZeroUnits(QObject *parent);

    /** Zero units.
      @note Source: https://en.zero.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        ZER,
...
typedef ZeroUnits::Unit ZeroUnit;

#endif // ZERO_QT_ZEROUNITS_H
