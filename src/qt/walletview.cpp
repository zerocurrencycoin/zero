    ...
    platformStyle(_platformStyle)
{
    ...
    //Add Radio Buttons
    QHBoxLayout *rvhbox_buttons = new QHBoxLayout();
    QRadioButton *zButton = new QRadioButton(tr("&Private Addresses"), this);
    zButton->setChecked(true);
    zButton->setObjectName("zAddresses");
    QRadioButton *tButton = new QRadioButton(tr("&Transparent Addresses"), this);
    tButton->setChecked(false);
    tButton->setObjectName("tAddresses");

    rvhbox_buttons->addWidget(zButton);
    rvhbox_buttons->addWidget(tButton);
    rvhbox_buttons->addStretch();
    rvbox->addLayout(rvhbox_buttons);
    ...
    usedReceivingAddressesPage->setVisible(false);
    rvbox->addWidget(receiveCoinsView);
    rvbox->addWidget(usedReceivingAddressesPage);
    ...
    //add ZeroNode page
    zeroNodePage = new QWidget(this);
    QVBoxLayout *znvbox = new QVBoxLayout();
    zeroNodeView = new ZeroNodePage(platformStyle, this);
    znvbox->addWidget(zeroNodeView);
    zeroNodePage->setLayout(znvbox);
    ...
    //Clicking Private or Transparent Radio Box changes addresses displayed
    connect(zButton, SIGNAL(clicked()), this, SLOT(showZAddresses()));
    connect(tButton, SIGNAL(clicked()), this, SLOT(showTAddresses()));
...
void WalletView::setZeroGUI(ZeroGUI *gui)
{
    if (gui)
    {
...
void WalletView::setWalletModel(WalletModel *_walletModel)
{
    ...
    zeroNodeView->setGlobalModel(_walletModel->getGlobalZNModel());
    zeroNodeView->setLocalModel(_walletModel->getLocalZNModel());
...
void WalletView::showZAddresses() {
    receiveCoinsView->setVisible(true);
    usedReceivingAddressesPage->setVisible(false);
}

void WalletView::showTAddresses() {
    receiveCoinsView->setVisible(false);
    usedReceivingAddressesPage->setVisible(true);
}
